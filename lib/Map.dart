...
class _Map extends State<Map>{
      ...
      (location){
        ...
        this.setState((){
          ...
          if (_trackingMyRoute) {
            ...
            _graphedPolylines.firstWhere((polyline) => polyline.polylineId.value == TRACKED_ROUTE_ID).points.add(coor);
          }
        });
      }
    );
  ...
  List<LatLng> getTrackedCoordinates(){
    return _graphedPolylines.firstWhere((polyline)=> polyline.polylineId.value == TRACKED_ROUTE_ID).points;
  }
  ...
  _trackMyRouteButtonHandler(){
    if (_trackingMyRoute) {
      ...
      myRoute.setCoordinates(_graphedPolylines.firstWhere((polyline)=> polyline.polylineId.value == TRACKED_ROUTE_ID).points);
      myRoute.endRoute();
   ...
   */
  restartTrackedPolyline(){
    _graphedPolylines.firstWhere((polyline) => polyline.polylineId == TRACKED_ROUTE_ID)
      .points
